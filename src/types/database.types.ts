...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      court_time_slots: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'court_time_slots_locked_by_fkey';
            columns: ['locked_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
      ...
      matches: {
        ...
        Relationships: [
          {
            foreignKeyName: 'fk_matches_conversation';
    ...
    Functions: {
      ...
      get_my_matches: {
        Args: { cursor_id?: string; limit_count?: number };
        Returns: {
          conversation_id: string;
          id: string;
          is_active: boolean;
      ...
      get_swipe_profiles: {
        ...
        Returns: {
          ...
          average_rating: number;
          bio: string;
          common_availability_slots: number;
          date_of_birth: string;
          display_name: string;
          distance_km: number;
          gender: string;
