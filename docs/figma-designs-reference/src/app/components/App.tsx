...
export default function App() {
  ...
  if (currentScreen === "onboarding") {
    return (
      <OnboardingScreen onGetStarted={() => setCurrentScreen("main")} />
    );
  }
        ...
        <nav className="bg-[#2a2a2a] border-t border-white/10 p-4">
          <div className="flex justify-around">
            ...
            >
              <Heart
                className={`w-6 h-6 ${
                  currentView === "dating" ? "fill-red-500 text-red-500" : ""
                }`}
              />
            ...
            >
              <Users
                className={`w-6 h-6 ${currentView === "opponents" ? "text-red-500" : ""}`}
              />
            ...
            >
              <MapPin
                className={`w-6 h-6 ${currentView === "courts" ? "text-red-500" : ""}`}
              />
            ...
            >
              <User
                className={`w-6 h-6 ${currentView === "profile" ? "text-red-500" : ""}`}
              />
